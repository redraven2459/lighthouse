...
class WaitingForTidekeeperAuthPage extends StatefulWidget {
  const WaitingForTidekeeperAuthPage({
    super.key,
  ...
  @override
  State<WaitingForTidekeeperAuthPage> createState() => _WaitingForTidekeeperAuthPageState();
}

class _WaitingForTidekeeperAuthPageState extends State<WaitingForTidekeeperAuthPage> {
  @override
  void initState() {
    super.initState();
      ...
      body: SafeArea(
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text("Waiting for Tidekeeper Auth:"),
